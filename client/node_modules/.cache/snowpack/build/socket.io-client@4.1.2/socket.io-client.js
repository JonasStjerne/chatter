...
import socket_io_parser_1 from 'socket.io-parser';
...
const debug = require$$0("socket.io-client:url");
/**
 * URL parser.
 *
 * @param uri - url
...
const debug = require$$0("socket.io-client:socket");
/**
 * Internal events.
...
const debug = require$$0("socket.io-client:manager");
class Manager extends typedEvents.StrictEventEmitter {
    constructor(uri, opts) {
        ...
        this.uri = uri;
        const _parser = opts.parser || socket_io_parser_1;
...
const debug = require$$0("socket.io-client");
/**
 * Module exports.
 */
